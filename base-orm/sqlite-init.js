  ...
  if (!existe) {
    ...
    await db.run(
      `
        ...
        (1, "FERNANDO ALONSO", "1981-07-29", 4, 361, 1),
        (2, "CHARLES LECLERC", "1997-10-16", 1, 107, 0),
        (3, "ALEXANDER ALBON", "1996-03-23", 7, 64, 0),
        (4, "VALTTERI BOTTAS", "1989-08-28", 6, 205, 0),
        (5, "MAX VERSTAPPEN", "1997-09-30", 2, 168, 1),
        (6, "KEVIN MAGNUSSEN", "1992-10-05", 9, 146, 0),
        (7, "LANDO NORRIS", "1999-11-13", 10, 87, 0),
        (8, "GEORGE RUSSELL", "1998-02-15", 3, 87, 0),
        (9, "PIERRE GASLY", "1996-02-07", 5, 113, 0),
        (10, "YUKI TSUNODA", "2000-05-11", 8, 47, 0)
      `
    );
  }
